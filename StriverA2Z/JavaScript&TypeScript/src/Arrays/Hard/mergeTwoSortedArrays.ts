function optimal1(arr1: number[], arr2: number[]) {
...
function optimal2(arr1: number[], arr2: number[]) {
...
function swapIfGreater(arr1: number[], arr2: number[], ind1: number, ind2: number) {
